<?php
    if (basename($_SERVER['PHP_SELF']) === 'footer.php') {
        if (isset($_SESSION['previous_url'])) {
            ...
            exit; // ¡Importante para asegurar que se detenga la ejecución del script!
        } else {
            header('Location: /');
            exit;
        }
        ...
        <footer>
            <div class="row item mt-2">
                <div class="izq">
                    ...
                    <h3>Tus marcas favoritas, a tu alcance</h3>
                </div>
                <div class="med">
                    <p> <a class="enlacesFooter" href="./avisolegal.php"> Aviso legal </a></p>
                    <p><a class="enlacesFooter" href="./cookies.php"> Politica de Cookies</a></p>
                    <p><a class="enlacesFooter" href="./privacidad.php"> Politica de Privacidad</a></p>
                    <p><a class="enlacesFooter" href="./faq.php"> FAQ</a></p>
                </div>
                <div class="der">
                    <div class="carta item mt-4 mr-2">
                        <a class="social-link1" id="mobileAppLink1" href="http://www.instagram.com/sergiitr11">
                        ...
                        <a class="social-link2" id="mobileAppLink2" href="https://github.com/sergiitr/">
                        ...
                        <a class="social-link4" id="mobileAppLink3" href="https://es.linkedin.com/in/sergiitr11">
                        ...
                        <a class="social-link5" href="https://stackoverflow.com/users/22172718/sergio-trillo">
                            <svg viewBox="0 0 16 16" class="bi bi-stack-overflow" fill="currentColor" height="12" width="12" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a class="email-link" href="mailto:contacto@sergiitrgames.com.es">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-envelope" viewBox="0 0 16 16">
                                ...
                                <path fill="#ffffff" d="M8 8.289L1.5 8.289zM1.5 5.44 8 9.172 14.5 5.44v-.88L8 8.289l-6.5-3.729v.88z"/>
                            </svg>
                        </a>
