                ...
                <div class="container-fluid mt-2">
                    <div class="text-end">
                        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                            <input type="hidden" name="currency" value="<?php echo isset($_POST['currency']) && $_POST['currency'] === 'USD' ? 'EUR' : 'USD'; ?>">
                            <button type="submit" class="btn btn-outline-primary">
                                <?php echo isset($_POST['currency']) && $_POST['currency'] === 'USD' ? 'Precios en Euros' : 'Precios en Dólares'; ?>
                            </button>
                        </form>
                    </div>
                </div>
