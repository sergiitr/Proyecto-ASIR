...
<html lang="es">
    <head>
        ...
        <script>
             ...
             * @param stockActual muestra por pantalla el stock actual del juego
             */
    ...
    <body>
        ...
        <?php
            ...
            ";
            /**
             * Funcion para coger los juegos de la base de datos
             * @param $plataforma para filtrar los juegos x plataforma
             */
            ...
            /**
             * Funcion que llama al procedimiento de cara a actualizar el stock de cada juego
             * @param $id posicion del juego en la base de datos
             * @param $nuevoStock nueva cantidad de stock de dicho juego
             */
